...
void make_root_dE_E_SiCsI_IQMD_01()
{
	TFile *openFile = new TFile("rawData_IQMD_01.root", "READ");
...
//	Double_t  edep1, edep2, edep3, edep4;
	...
	TTree *SimulationTree01 = (TTree *) openFile -> Get("SimulationData"); //meaningless?
		...
		SimulationTree01 -> SetBranchAddress("copyNum", &copyNum);


	TFile *writeFile = new TFile("dE_E_SiCsI_IQMD_01.root", "RECREATE");
