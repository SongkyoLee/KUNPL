...
void draw_energyInit_IQMD_oneDetector(Int_t selectData, Int_t selectXBins, Double_t selectMinX, Double_t selectMaxX)
//void draw_energyInit_IQMD_all(Int_t selectData)
{
  ...
  TTree* tempTree = dE_E_Tree.CopyTree("pID!=2112&&pID!=111&&copyNum>=300&&copyNum<400");
