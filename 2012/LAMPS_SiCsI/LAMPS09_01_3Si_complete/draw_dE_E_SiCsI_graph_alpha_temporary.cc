...
void draw_dE_E_SiCsI_graph_alpha(Int_t selectData, Int_t selectParticle, Int_t selectXBins, Double_t selectMinX, Double_t selectMaxX, Int_t selectYBins, Double_t selectMinY, Double_t selectMaxY)
{
	// data specification
...
//	dE_E_Tree.Add("dE_E_SiCsI_triton.root");
	...
	TF1* gr1 = new TF1("fit1", fitfunc, 50.0, 200.0, 3);
	TF1* gr2 = new TF1("fit2", fitfunc, 200.0, 540.0, 3);
	gr1->SetParameters(0.00015,200,2.216);
	gr2->SetParameters(0.000011,540,0.95);
...
//TPaveStats *stats = (TPaveStats *) hist -> FindObject("stats");
	...
	cvs -> SaveAs(Form("dE_E_SiCsI_%d_%s_graph04.png", particleName[selectParticle], dataName[selectData]));
}
