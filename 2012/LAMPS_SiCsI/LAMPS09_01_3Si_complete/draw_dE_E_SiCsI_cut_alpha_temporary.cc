...
void draw_dE_E_SiCsI_cut_triton(Int_t selectData, Int_t selectParticle, Int_t selectXBins, Double_t selectMinX, Double_t selectMaxX, Int_t selectYBins, Double_t selectMinY, Double_t selectMaxY)
{
	// data specification
...
// proton, deuteron, tau, alpha, +pion, -pion
	...
	Double_t leftPnt = 40.0;
	Double_t middlePnt = 100.0;
	Double_t rightPnt = 230.0;
	Double_t a1 = 0.0007;
...
//TPaveStats *stats = (TPaveStats *) hist -> FindObject("stats");
	...
	cvs -> SaveAs(Form("dE_E_SiCsI_%d_%s_cut_triton.png", particleName[selectParticle], dataName[selectData]));
}
