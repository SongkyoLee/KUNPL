...
void draw_dE_E_SiCsI_graph_deuteron(Int_t selectData, Int_t selectParticle, Int_t selectXBins, Double_t selectMinX, Double_t selectMaxX, Int_t selectYBins, Double_t selectMinY, Double_t selectMaxY)
{
	// data specification
...
//	dE_E_Tree.Add("dE_E_SiCsI_alpha.root");
	...
	TF1* gr1 = new TF1("fit1", fitfunc, 30.0, 80.0, 3);
	TF1* gr2 = new TF1("fit2", fitfunc, 80.0, 200.0, 3);
	gr1->SetParameters(0.0009,80,1.908);
	gr2->SetParameters(0.00007,200,0.9);
...
//TPaveStats *stats = (TPaveStats *) hist -> FindObject("stats");
	...
	cvs -> SaveAs(Form("dE_E_SiCsI_%d_%s_graph02.png", particleName[selectParticle], dataName[selectData]));
}
