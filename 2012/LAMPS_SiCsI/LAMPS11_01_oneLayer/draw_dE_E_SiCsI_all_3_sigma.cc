...
void draw_dE_E_SiCsI_all_3_sigma(Int_t selectData, Int_t selectXBins, Double_t selectMinX, Double_t selectMaxX, Int_t selectYBins, Double_t selectMinY, Double_t selectMaxY)
{
	// data specification
...
//	dE_E_Tree.Add("dE_E_SiCsI_alpha.root");
	...
	cvs -> SaveAs(Form("dE_E_SiCsI_%s_all_3_sigma.png", dataName[selectData]));
}
