...
void draw_dE_E_SiCsI_all_1(Int_t selectData, Int_t selectXBins, Double_t selectMinX, Double_t selectMaxX, Int_t selectYBins, Double_t selectMinY, Double_t selectMaxY)
{
	// data specification
	...
	cvs -> SaveAs(Form("dE_E_SiCsI_%s_all_1.png", dataName[selectData]));
}
