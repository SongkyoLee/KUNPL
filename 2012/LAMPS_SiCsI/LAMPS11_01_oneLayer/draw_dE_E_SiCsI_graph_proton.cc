...
void draw_dE_E_SiCsI_graph_proton(Int_t selectData, Int_t selectParticle, Int_t selectXBins, Double_t selectMinX, Double_t selectMaxX, Int_t selectYBins, Double_t selectMinY, Double_t selectMaxY)
{
	// data specification
...
//	dE_E_Tree.Add("dE_E_SiCsI_alpha.root");
	...
	TF1* gr1 = new TF1("fit1", fitfunc, 10.0, 50.0, 3);
	TF1* gr2 = new TF1("fit2", fitfunc, 50.0, 150.0, 3);
	gr1->SetParameters(0.00150,50,1.6);
	gr2->SetParameters(0.00010,150,0.6);
...
//TPaveStats *stats = (TPaveStats *) hist -> FindObject("stats");
	...
	cvs -> SaveAs(Form("dE_E_SiCsI_%d_%s_graph01.png", particleName[selectParticle], dataName[selectData]));
}
