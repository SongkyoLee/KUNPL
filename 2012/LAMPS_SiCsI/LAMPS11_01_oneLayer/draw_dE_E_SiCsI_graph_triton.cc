...
void draw_dE_E_SiCsI_graph_triton(Int_t selectData, Int_t selectParticle, Int_t selectXBins, Double_t selectMinX, Double_t selectMaxX, Int_t selectYBins, Double_t selectMinY, Double_t selectMaxY)
{
	// data specification
...
//	dE_E_Tree.Add("dE_E_SiCsI_alpha.root");
	...
	TF1* gr1 = new TF1("fit1", fitfunc, 40.0, 100.0, 3);
	TF1* gr2 = new TF1("fit2", fitfunc, 100.0, 230.0, 3);
	gr1->SetParameters(0.0007,100.0,2.314);
	gr2->SetParameters(0.00006,230.0,1.3);
...
//TPaveStats *stats = (TPaveStats *) hist -> FindObject("stats");
	...
	cvs -> SaveAs(Form("dE_E_SiCsI_%d_%s_graph03.png", particleName[selectParticle], dataName[selectData]));
}
