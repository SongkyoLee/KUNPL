...
void draw_dE_E_SiCsI_1(Int_t selectData, Int_t selectParticle, Int_t selectXBins, Double_t selectMinX, Double_t selectMaxX, Int_t selectYBins, Double_t selectMinY, Double_t selectMaxY)
{
	// data specification
...
// proton, deuteron, tau, alpha, +pion, -pion
	...
	cvs -> SaveAs(Form("dE_E_SiCsI_%d_%s_1.png", particleName[selectParticle], dataName[selectData]));
}
