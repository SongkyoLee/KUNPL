...
// For cubic world volume
  ...
  //=============================================================
    ...
    const G4double ANGLE = 19.0*degree; // polar angle of center axis
  ...
  //===================================================
    ...
    G4Box *SiF1_Solid = new G4Box("SiF1_Solid", DX1/2, DX1/2, DZ_SiF/2);
    G4LogicalVolume *SiF1_LV = new G4LogicalVolume(SiF1_Solid, Silicon, "SiF1_LV");

for(G4int i=0; i<4; i++)
{
// ~~~~~~~~~~ for (1) ~~~~~~~~~~~~~~~~~~
		new G4PVPlacement(0, G4ThreeVector(DX1/2, DX1/2, DZ_OFFSET_surface-DZ_SiT-DZ_SiS-DZ_SiF/2).rotateZ(90*i*degree), Form("SiF1_PV_%d",i), SiF1_LV, expHall, false, i); 
// ~~~~~~~~~~ for (5) ~~~~~~~~~~~~~~~~~~
		new G4PVPlacement(0, G4ThreeVector(DX1/2, DX1*3/2, DZ_OFFSET_surface-DZ_SiT-DZ_SiS-DZ_SiF/2).rotateZ(90*i*degree), Form("SiF1_PV_%d",i+4), SiF1_LV, expHall, false, i+4); 
// ~~~~~~~~~~ for (13) ~~~~~~~~~~~~~~~~~~
		new G4PVPlacement(0, G4ThreeVector(DX1*3/2, DX1*3/2, DZ_OFFSET_surface-DZ_SiT-DZ_SiS-DZ_SiF/2).rotateZ(90*i*degree), Form("SiF1_PV_%d",i+8), SiF1_LV, expHall, false, i+8); 
// ~~~~~~~~~~ for (9) ~~~~~~~~~~~~~~~~~~
		new G4PVPlacement(0, G4ThreeVector(DX1*3/2, DX1/2, DZ_OFFSET_surface-DZ_SiT-DZ_SiS-DZ_SiF/2).rotateZ(90*i*degree), Form("SiF1_PV_%d",i+12), SiF1_LV, expHall, false, i+12); 
}
  ...
  //===================================================
    ...
    G4Box *SiS1_Solid = new G4Box("SiS1_Solid", DX1/2, DX1/2, DZ_SiS/2);
    G4LogicalVolume *SiS1_LV = new G4LogicalVolume(SiS1_Solid, Silicon, "SiS1_LV");

for(G4int i=0; i<4; i++)
{
// ~~~~~~~~~~ for (1) ~~~~~~~~~~~~~~~~~~
		new G4PVPlacement(0, G4ThreeVector(DX1/2, DX1/2, DZ_OFFSET_surface-DZ_SiT-DZ_SiS/2).rotateZ(90*i*degree), Form("SiS1_PV_%d",i), SiS1_LV, expHall, false, i); 
// ~~~~~~~~~~ for (5) ~~~~~~~~~~~~~~~~~~
		new G4PVPlacement(0, G4ThreeVector(DX1/2, DX1*3/2, DZ_OFFSET_surface-DZ_SiT-DZ_SiS/2).rotateZ(90*i*degree), Form("SiS1_PV_%d",i+4), SiS1_LV, expHall, false, i+4); 
// ~~~~~~~~~~ for (13) ~~~~~~~~~~~~~~~~~~
		new G4PVPlacement(0, G4ThreeVector(DX1*3/2, DX1*3/2, DZ_OFFSET_surface-DZ_SiT-DZ_SiS/2).rotateZ(90*i*degree), Form("SiS1_PV_%d", i+8), SiS1_LV, expHall, false, i+8); 
// ~~~~~~~~~~ for (9) ~~~~~~~~~~~~~~~~~~
		new G4PVPlacement(0, G4ThreeVector(DX1*3/2, DX1/2, DZ_OFFSET_surface-DZ_SiT-DZ_SiS/2).rotateZ(90*i*degree), Form("SiS1_PV_%d", i+12), SiS1_LV, expHall, false, i+12); 
}
  ...
  //===================================================
    ...
    G4Box *SiT1_Solid = new G4Box("SiT1_Solid", DX1/2, DX1/2, DZ_SiT/2);
    G4LogicalVolume *SiT1_LV = new G4LogicalVolume(SiT1_Solid, Silicon, "SiT1_LV");

for(G4int i=0; i<4; i++)
{
// ~~~~~~~~~~ for (1) ~~~~~~~~~~~~~~~~~~
		new G4PVPlacement(0, G4ThreeVector(DX1/2, DX1/2, DZ_OFFSET_surface-DZ_SiT/2).rotateZ(90*i*degree), Form("SiT1_PV_%d",i), SiT1_LV, expHall, false, i); 
// ~~~~~~~~~~ for (5) ~~~~~~~~~~~~~~~~~~
		new G4PVPlacement(0, G4ThreeVector(DX1/2, DX1*3/2, DZ_OFFSET_surface-DZ_SiT/2).rotateZ(90*i*degree), Form("SiT1_PV_%d", i+4), SiT1_LV, expHall, false, i+4); 
// ~~~~~~~~~~ for (13) ~~~~~~~~~~~~~~~~~~
		new G4PVPlacement(0, G4ThreeVector(DX1*3/2, DX1*3/2, DZ_OFFSET_surface-DZ_SiT/2).rotateZ(90*i*degree), Form("SiT1_PV_%d",i+8), SiT1_LV, expHall, false, i+8); 
// ~~~~~~~~~~ for (9) ~~~~~~~~~~~~~~~~~~
		new G4PVPlacement(0, G4ThreeVector(DX1*3/2, DX1/2, DZ_OFFSET_surface-DZ_SiT/2).rotateZ(90*i*degree), Form("SiT1_PV_%d",i+12), SiT1_LV, expHall, false, i+12); 
}
...
// ~~~~~~~~~~ for (1) ~~~~~~~~~~~~~~~~~~
    G4Trap *CsI1_solid = new G4Trap("CsI1_solid", DZ_CsI/2,
		(TMath::ATan(TMath::Sqrt((DX2/2-DX1/2)*(DX2/2-DX1/2)+(DX2/2-DX1/2)*(DX2/2-DX1/2))/(DZ_CsI)))*(180/TMath::Pi())*degree, TMath::ATan((DX2/2-DX1/2)/(DX2/2-DX1/2))*(180/TMath::Pi())*degree,
...
// ~~~~~~~~~~ for (5) ~~~~~~~~~~~~~~~~~~
    G4Trap *CsI2_solid = new G4Trap("CsI2_solid", DZ_CsI/2,
		(TMath::ATan(TMath::Sqrt((DX2/2-DX1/2)*(DX2/2-DX1/2)+(DX2/2)*(DX2/2))/(DZ_CsI)))*(180/TMath::Pi())*degree, TMath::ATan((DX2/2)/(DX2/2-DX1/2))*(180/TMath::Pi())*degree,
												DX1/2, DX1/2, DX1/2, 0*degree, DX2/2, DX2/2, DX2/2, 0*degree);
    G4LogicalVolume *CsI2_LV = new G4LogicalVolume(CsI2_solid, CsI, "CsI2_LV");
	  
// ~~~~~~~~~~ for (13) ~~~~~~~~~~~~~~~~~~
    G4Trap *CsI3_solid = new G4Trap("CsI3_solid", DZ_CsI/2,
		(TMath::ATan(TMath::Sqrt((DX2/2)*(DX2/2)+(DX2/2)*(DX2/2))/(DZ_CsI)))*(180/TMath::Pi())*degree, TMath::ATan((DX2/2)/(DX2/2))*(180/TMath::Pi())*degree,
												DX1/2, DX1/2, DX1/2, 0*degree, DX2/2, DX2/2, DX2/2, 0*degree);
    G4LogicalVolume *CsI3_LV = new G4LogicalVolume(CsI3_solid, CsI, "CsI3_LV");

// ~~~~~~~~~~ for (9) ~~~~~~~~~~~~~~~~~~
    G4Trap *CsI4_solid = new G4Trap("CsI4_solid", DZ_CsI/2,
		(TMath::ATan(TMath::Sqrt((DX2/2-DX1/2)*(DX2/2-DX1/2)+(DX2/2)*(DX2/2))/(DZ_CsI)))*(180/TMath::Pi())*degree, TMath::ATan((DX2/2-DX1/2)/(DX2/2))*(180/TMath::Pi())*degree,
												DX1/2, DX1/2, DX1/2, 0*degree, DX2/2, DX2/2, DX2/2, 0*degree);
    G4LogicalVolume *CsI4_LV = new G4LogicalVolume(CsI4_solid, CsI, "CsI4_LV");

	for(G4int i=0; i<4; i++)
	{
		new G4PVPlacement(new G4RotationMatrix(90*i*degree,0,0), G4ThreeVector(DX1/2+(DX2-DX1)/4, DX1/2+(DX2-DX1)/4, DZ_OFFSET_surface+DZ_CsI/2).rotateZ(90*i*degree), Form( "CsI1_PV_%d",i), CsI1_LV, expHall, false, 0);
		new G4PVPlacement(new G4RotationMatrix(90*i*degree,0,0), G4ThreeVector(DX1/2+(DX2-DX1)/4, DX2+DX2/4, DZ_OFFSET_surface+DZ_CsI/2).rotateZ(90*i*degree), Form("CsI2_PV_%d",i), CsI2_LV, expHall, false, 0);
		new G4PVPlacement(new G4RotationMatrix(90*i*degree,0,0), G4ThreeVector(DX2+DX2/4, DX2+DX2/4, DZ_OFFSET_surface+DZ_CsI/2).rotateZ(90*i*degree), Form("CsI3_PV_%d",i), CsI3_LV, expHall, false, i);
		new G4PVPlacement(new G4RotationMatrix(90*i*degree,0,0), G4ThreeVector(DX2+DX2/4, DX1/2+(DX2-DX1)/4, DZ_OFFSET_surface+DZ_CsI/2).rotateZ(90*i*degree), Form("CsI4_PV_%d",i), CsI4_LV, expHall, false, i);
  }
  ...
  //===================================================
    ...
    G4Box *SiV1_Solid = new G4Box("SiV1_Solid", DX2/2, DX2/2, DZ_SiV/2);
    G4LogicalVolume *SiV1_LV = new G4LogicalVolume(SiV1_Solid, Silicon, "SiV1_LV");
		for (G4int i=0; i<4; i++)
		{
// ~~~~~~~~~~ for (1) ~~~~~~~~~~~~~~~~~~
		new G4PVPlacement(0, G4ThreeVector(DX2/2, DX2/2, DZ_OFFSET_surface+DZ_CsI+DZ_SiV/2).rotateZ(90*i*degree), Form("SiV1_PV_%d",i), SiV1_LV, expHall, false, i); 
// ~~~~~~~~~~ for (5) ~~~~~~~~~~~~~~~~~~
		new G4PVPlacement(0, G4ThreeVector(DX2/2, DX2*3/2, DZ_OFFSET_surface+DZ_CsI+DZ_SiV/2).rotateZ(90*i*degree), Form("SiV1_PV_%d",i+4), SiV1_LV, expHall, false, i+4); 
// ~~~~~~~~~~ for (13) ~~~~~~~~~~~~~~~~~~
		new G4PVPlacement(0, G4ThreeVector(DX2*3/2, DX2*3/2, DZ_OFFSET_surface+DZ_CsI+DZ_SiV/2).rotateZ(90*i*degree), Form("SiV1_PV_%d",i+8), SiV1_LV, expHall, false, i+8); 
// ~~~~~~~~~~ for (9) ~~~~~~~~~~~~~~~~~~
		new G4PVPlacement(0, G4ThreeVector(DX2*3/2, DX2/2, DZ_OFFSET_surface+DZ_CsI+DZ_SiV/2).rotateZ(90*i*degree), Form("SiV1_PV_%d",i+12), SiV1_LV, expHall, false, i+12); 
}

   G4VisAttributes* SiV_VisAtt = new G4VisAttributes(G4Colour(0., 1., 0.));
   SiV1_LV -> SetVisAttributes(SiV_VisAtt);
...
*/
  ...
  // ===========================================
	...
	SiCsISD* SiV1_SD = new SiCsISD(SDname="/SiCsI/SiV1_SD", "SiV1");
	SiV1_SD -> SetROgeometry(SICSI_RO_GEOMETRY);
	SDman -> AddNewDetector(SiV1_SD);
	SiV1_LV -> SetSensitiveDetector(SiV1_SD);
