...
void exampleDetectorConstruction::DefineDimensions()
{
    ...
    target = 0;         // z-component of the target's position vector  //KYO
...
G4VPhysicalVolume* exampleDetectorConstruction::Construct()
{
 ...
 //   tpcLV -> SetVisAttributes(detVisAttribtpc);
    ...
    // Readout Geometry
    exampleDetectorROGeometry *detROGeometry = new exampleDetectorROGeometry("detROGeometry", labX, labY, labZ, labX, labY, labZ, G4ThreeVector(0, 0, 0*cm));
