...
void divide_rawData_IQMD()
{
	...
	TFile *writeFile01 = new TFile("rawData_IQMD_01.root", "RECREATE");
	...
	TFile *writeFile02 = new TFile("rawData_IQMD_02.root", "RECREATE");
	...
	TFile *writeFile03= new TFile("rawData_IQMD_03.root", "RECREATE");
	...
	TFile *writeFile04= new TFile("rawData_IQMD_04.root", "RECREATE");
	...
	TFile *writeFile05= new TFile("rawData_IQMD_05.root", "RECREATE");
	...
	TFile *writeFile06= new TFile("rawData_IQMD_06.root", "RECREATE");
	...
	TFile *writeFile07= new TFile("rawData_IQMD_07.root", "RECREATE");
	...
	TFile *writeFile08= new TFile("rawData_IQMD_08.root", "RECREATE");
	...
	TFile *writeFile09= new TFile("rawData_IQMD_09.root", "RECREATE");
	...
	TFile *writeFile10= new TFile("rawData_IQMD_10.root", "RECREATE");
