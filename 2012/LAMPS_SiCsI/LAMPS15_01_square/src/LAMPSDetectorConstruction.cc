...
// For cubic world volume
  ...
  //=============================================================
    ...
    const G4double DZ_CsI  = 130*mm;		//These DZ are along the rotated z axes.
    const G4double DZ_OFFSET_surface = 230*mm;	// from target to front surface of CsI
		const G4double DX1 = 40*mm; // x & y of front surface of CsI 
		const G4double DX2 = 60*mm; // x & y of back surface of CsI
  ...
  //===================================================
    ...
    { 
        new G4PVPlacement(new G4RotationMatrix((360/PADNUM)*i*degree, -ANGLE, 0*degree),
			 G4ThreeVector(0*mm, 0*mm,(DZ_OFFSET_surface-DZ_SiT-DZ_SiS-(DZ_SiF/2))*mm)
				.rotateX(-ANGLE).rotateZ((360/PADNUM)*i*degree),
			 Form("SiF1_PV_%d", i),
			 SiF1_LV,
			 expHall,
			 false,
    ...
    { 
        new G4PVPlacement(new G4RotationMatrix((360/PADNUM)*i*degree, -ANGLE, 0*degree),
			 G4ThreeVector(0*mm, 0*mm,
				(DZ_OFFSET_surface-(DZ_SiT/2))*mm).rotateX(-ANGLE).rotateZ((360/PADNUM)*i*degree),
			 Form("SiT1_PV_%d", i),
			 SiT1_LV,
			 expHall,
			 false,
  ...
  //===================================================
    ...
    G4Trap *CsI1_solid = new G4Trap("CsI1_solid", DZ_CsI/2, 0*degree, 0*degree, 
															DX1/2, DX1/2, DX1/2, 0*degree, 
															DX2/2, DX2/2, DX2/2, 0*degree);
  ...
  //===================================================
    ...
    { 
        new G4PVPlacement(new G4RotationMatrix((360/PADNUM)*i*degree, -ANGLE, 0*degree),
			 G4ThreeVector(0*mm, 0*mm,
				(DZ_OFFSET_surface+DZ_CsI+(DZ_SiV/2))*mm)
				.rotateX(-ANGLE).rotateZ((360/PADNUM)*i*degree),
			 Form("SiV1_PV_%d", i),
			 SiV1_LV,
			 expHall,
