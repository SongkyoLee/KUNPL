...
void draw_dE_E_SiCsI_IQMD_3(Int_t selectData, Int_t selectParticle, Int_t selectXBins, Double_t selectMinX, Double_t selectMaxX, Int_t selectYBins, Double_t selectMinY, Double_t selectMaxY)
{
	// data specification
  ...
  Double_t deltaE, largeE;
   ...
   tempTree -> GetEntry(i);
	 if(edep1!=0&&edep2!=0&&edep3!=0&&edep4!=0)
	...
	cvs -> SaveAs(Form("dE_E_SiCsI_%d_%s_IQMD_3.png", particleName[selectParticle], dataName[selectData]));
}
