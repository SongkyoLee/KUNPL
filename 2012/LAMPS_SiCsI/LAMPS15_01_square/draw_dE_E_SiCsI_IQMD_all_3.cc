...
void draw_dE_E_SiCsI_IQMD_all_3(Int_t selectData, Int_t selectXBins, Double_t selectMinX, Double_t selectMaxX, Int_t selectYBins, Double_t selectMinY, Double_t selectMaxY)
{
	// data specification
  ...
  Double_t deltaE, largeE;
   ...
   dE_E -> GetEntry(i);
	...
	cvs -> SaveAs(Form("dE_E_SiCsI_%s_IQMD_all_3.png", dataName[selectData]));
}
