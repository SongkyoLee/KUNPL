...
void LAMPSAnaRoot::FillToF(Int_t r_pNum, Int_t r_detID, Int_t r_parentID, Int_t r_pID, Int_t r_detNum, Double_t r_energyDeposit, Double_t r_hitTime, Double_t r_momX, Double_t r_momY, Double_t r_momZ)
{
	if (r_energyDeposit == 0) return;
