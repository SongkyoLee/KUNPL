...
void draw_pT_y_TPC(Int_t selectData, Int_t selectParticle, Int_t selectXBins, Double_t selectMinX, Double_t selectMaxX, Int_t selectYBins, Double_t selectMinY, Double_t selectMaxY)
{
	// data specification
...
// proton, deuteron, tau, alpha, +pion, -pion
	...
	TFile *openFile = new TFile("pT_y_TPC.root");
...
//	cvs -> SaveAs(saveFileName.str().c_str());
	cvs -> SaveAs(Form("pT_y_TPC_%d_%s.png",
