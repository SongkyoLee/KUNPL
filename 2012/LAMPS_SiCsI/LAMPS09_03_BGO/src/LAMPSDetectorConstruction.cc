...
// For cubic world volume
  ...
  //=============================================================
    ...
    const G4double DZ_OFFSET_surface = 230*mm;	// from targer to front surface of 1st CsI
  ...
  //===================================================
    ...
    G4LogicalVolume *CsI1_LV = new G4LogicalVolume(CsI1_solid, BGO, "CsI1_LV");
  ...
  //===================================================
    ...
    G4Box *SiF2_Solid = new G4Box("SiF2_Solid", 
				(DZ_OFFSET_surface+DZ_CsI+DZ_OFFSET_layer)
    ...
    { 
        new G4PVPlacement(new G4RotationMatrix(-(360/PADNUM)*i*degree, -ANGLE2, 0*degree),
			 G4ThreeVector(0*mm, 0*mm,
				(DZ_OFFSET_surface+DZ_CsI+DZ_OFFSET_layer-DZ_SiT-DZ_SiS-(DZ_SiF/2))*mm)
  ...
  //===================================================
    ...
    G4Box *SiS2_Solid = new G4Box("SiS2_Solid", 
				(DZ_OFFSET_surface+DZ_CsI+DZ_OFFSET_layer)*(1/TMath::Cos(COVERAGE/2))
				*TMath::Sin(ANGLE2-(COVERAGE/2))
				*TMath::Tan((0.5*360/PADNUM)*degree)*mm,
	 			(DZ_OFFSET_surface+DZ_CsI)*TMath::Tan(COVERAGE/2)*mm,
				DZ_SiS/2);
    ...
    { 
        new G4PVPlacement(new G4RotationMatrix(-(360/PADNUM)*i*degree, -ANGLE2, 0*degree),
			 G4ThreeVector(0*mm, 0*mm,
				(DZ_OFFSET_surface+DZ_CsI+DZ_OFFSET_layer-DZ_SiT-(DZ_SiS/2))*mm).rotateX(-ANGLE2).rotateZ(-(360/PADNUM)*i*degree),
			 Form("SiS2_PV_%d", i),
			 SiS2_LV,
			 expHall,
			 false,
  ...
  //===================================================
    ...
    { 
        new G4PVPlacement(new G4RotationMatrix(-(360/PADNUM)*i*degree, -ANGLE2, 0*degree),
			 G4ThreeVector(0*mm, 0*mm,
				(DZ_OFFSET_surface+DZ_CsI+DZ_OFFSET_layer-(DZ_SiT/2))*mm)
				.rotateX(-ANGLE2).rotateZ(-(360/PADNUM)*i*degree),
			 Form("SiT1_PV_%d", i),
			 SiT2_LV,
			 expHall,
  ...
  //===================================================
    ...
    G4Trap *CsI2_solid = new G4Trap("CsI2_solid",
				...
				0*degree, 
				0*degree,
        			(DZ_OFFSET_surface+DZ_CsI+DZ_OFFSET_layer)*TMath::Tan(COVERAGE/2)*mm,
        			(DZ_OFFSET_surface+DZ_CsI+DZ_OFFSET_layer)*(1/TMath::Cos(COVERAGE/2))
					*TMath::Sin(ANGLE2-(COVERAGE/2))
					*TMath::Tan((0.5*360/PADNUM)*degree)*mm,
        			(DZ_OFFSET_surface+DZ_OFFSET_layer+DZ_CsI)*(1/TMath::Cos(COVERAGE/2))
					*TMath::Sin(ANGLE2-(COVERAGE/2))
					*TMath::Tan((0.5*360/PADNUM)*degree)*mm,
				0*degree,
        			(DZ_OFFSET_surface+DZ_OFFSET_layer+2*DZ_CsI)*TMath::Tan(COVERAGE/2)*mm,
        			(DZ_OFFSET_surface+DZ_OFFSET_layer+2*DZ_CsI)*(1/TMath::Cos(COVERAGE/2))
					*TMath::Sin(ANGLE2-COVERAGE/2)
					*TMath::Tan((0.5*360/PADNUM)*degree)*mm,
        			(DZ_OFFSET_surface+DZ_OFFSET_layer+2*DZ_CsI)*(1/TMath::Cos(COVERAGE/2))
					*TMath::Sin(ANGLE2-COVERAGE/2)
    ...
    G4LogicalVolume *CsI2_LV = new G4LogicalVolume(CsI2_solid, BGO, "CsI2_LV");

    for(G4int i=0; i<PADNUM; i++)
    { 
        new G4PVPlacement(new G4RotationMatrix(-(360/PADNUM)*i*degree, -ANGLE2, 0*degree),
       			G4ThreeVector(0*mm, 0*mm, (DZ_OFFSET_surface+DZ_OFFSET_layer+(3*DZ_CsI/2))*mm)
				.rotateX(-ANGLE2).rotateZ(-(360/PADNUM)*i*degree),
			Form("CsI2_PV_%d", i), 
			CsI2_LV, 
			expHall, 
