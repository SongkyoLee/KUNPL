...
LAMPSAnaRoot::LAMPSAnaRoot()
{
  ...
  // IQMD Data Tree Making
	...
	simulationDataTree = new TTree("SimulationData", "Simulation Data is stored");
		...
		simulationDataTree -> Branch("isSiCsI", &isSiCsI, "isSiCsI/I"); //KYO
...
void LAMPSAnaRoot::FillSiCsI(Int_t r_pNum, Int_t r_parentID, Int_t r_pID, Double_t preX, Double_t preY, Double_t preZ, Double_t postX, Double_t postY, Double_t postZ, Double_t r_energyDeposit, Double_t r_hitTime, Int_t r_detNum) //KYO
{
	if (r_energyDeposit == 0) return;
