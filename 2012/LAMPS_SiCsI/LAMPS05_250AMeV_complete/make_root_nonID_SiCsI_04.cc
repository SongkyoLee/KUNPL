...
void make_root_nonID_SiCsI_04(Int_t selectData, Int_t selectParticle, Int_t selectXBins, Double_t selectMinX, Double_t selectMaxX, Int_t selectYBins, Double_t selectMinY, Double_t selectMaxY)
{
	// data specification
...
// proton, deuteron, tau, alpha, +pion, -pion
	...
	if(edep1!=0&&edep2!=0&&edep1<5.591&&edep2<540&&((edep2<200&&edep1<0.00015*(edep2-200)*(edep2-200)+2.216)||(edep2>=200.0&&edep1<0.000011*(edep2-540)*(edep2-540)+0.95)))
	{tempTree2->Fill();}
	else if(edep3!=0&&edep4!=0&&edep3<5.591&&edep4<540&&((edep4<200.0&&edep3<0.00015*(edep4-200)*(edep4-200)+2.216)||(edep4>=200.0&&edep3<0.000011*(edep4-540)*(edep4-540)+0.95)))
	{tempTree2->Fill();}
	}
	...
	TFile *writeFile = new TFile("nonID_SiCsI_04.root","RECREATE");
