...
void draw_dE_E_SiCsI_graph01(Int_t selectData, Int_t selectParticle, Int_t selectXBins, Double_t selectMinX, Double_t selectMaxX, Int_t selectYBins, Double_t selectMinY, Double_t selectMaxY)
{
	// data specification
...
// proton, deuteron, tau, alpha, +pion, -pion
	...
	TF1* gr2 = new TF1("fit2", fitfunc, 50.0, 120.0, 3);
	gr1->SetParameters(0.00065,50,0.5);
	gr2->SetParameters(0.00006,120,0.2);
