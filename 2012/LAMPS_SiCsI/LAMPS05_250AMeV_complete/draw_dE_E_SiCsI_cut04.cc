...
void draw_dE_E_SiCsI_cut04(Int_t selectData, Int_t selectParticle, Int_t selectXBins, Double_t selectMinX, Double_t selectMaxX, Int_t selectYBins, Double_t selectMinY, Double_t selectMaxY)
{
	// data specification
...
//TPaveStats *stats = (TPaveStats *) hist -> FindObject("stats");
	...
	cvs -> SaveAs(Form("dE_E_SiCsI_%d_%s_cut04.png", particleName[selectParticle], dataName[selectData]));
}
