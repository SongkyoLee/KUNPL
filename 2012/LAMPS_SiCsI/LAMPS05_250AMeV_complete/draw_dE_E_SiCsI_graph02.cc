...
void draw_dE_E_SiCsI_graph02(Int_t selectData, Int_t selectParticle, Int_t selectXBins, Double_t selectMinX, Double_t selectMaxX, Int_t selectYBins, Double_t selectMinY, Double_t selectMaxY)
{
	// data specification
...
// proton, deuteron, tau, alpha, +pion, -pion
	...
	TF1* gr1 = new TF1("fit1", fitfunc, 20.0, 55.0, 3);
	TF1* gr2 = new TF1("fit2", fitfunc, 55.0, 150.0, 3);
	gr1->SetParameters(0.0009,55,0.8415);
	gr2->SetParameters(0.00006,150,0.3);
