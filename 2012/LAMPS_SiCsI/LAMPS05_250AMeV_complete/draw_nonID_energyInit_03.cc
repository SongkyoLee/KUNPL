...
void draw_nonID_energyInit_03(Int_t selectXBins, Double_t selectMinX, Double_t selectMaxX)
{
	// start drawing
	...
	//hist01 -> Scale(1/entries01); // normalization
	hist01 -> Draw("");
	...
	//hist02 -> Scale(1/entries02); // normalization
	hist02 -> Draw("same");
	...
	//hist03 -> Scale(1/entries03); // normalization
	hist03 -> Draw("same");
	...
	//hist04 -> Scale(1/entries04); // normalization
	hist04 -> Draw("same");
	...
	cvs -> Update();
	cvs -> SaveAs("nonID_energyInit_03.png");
	return;
}
