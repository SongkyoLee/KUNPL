...
*/
  ...
  const G4double ROUT_TPC_IN	= 450.*mm;
  const G4double RIN_TPC_IN	= 200.*mm;
  ...
  G4LogicalVolume* TPC_LV_IN = new G4LogicalVolume(TPC_Solid_IN, ArEthane, "TPC_LV_IN");
  ...
  const G4double ROUT_TPC_IF	= 200.2*mm;
  const G4double RIN_TPC_IF	= 200.*mm;
  ...
  const G4double ROUT_TPC_OF	= 450.*mm;
  const G4double RIN_TPC_OF	= 445.*mm;
  ...
  const G4double HALF_PAD_FRAME_SHORT_SIDE	= 76.54*mm;
  const G4double HALF_PAD_FRAME_LONG_SIDE	= 191.34*mm;
  const G4double HALF_PAD_FRAME_RADIAL_LENGTH	= 138.58*mm;
  const G4double PAD_FRAME_RADIAL_POSITION	= 323.36*mm;
  ...
  const G4double HALF_PAD_INSIDE_SHORT_SIDE	= 76.4*mm;
  const G4double HALF_PAD_INSIDE_LONG_SIDE	= 191.04*mm;
  const G4double HALF_PAD_INSIDE_RADIAL_LENGTH	= 138.38*mm;
  ...
  for (G4int i = 0; i != NUM_PAD; i++)
  {
	...
	PAD_INSIDE_UP_LV[i] = new G4LogicalVolume(PAD_INSIDE, ArEthane, PAD_INSIDE_UP_LV_NAME.str().c_str());
	...
	PAD_INSIDE_DOWN_LV[i] = new G4LogicalVolume(PAD_INSIDE, ArEthane, PAD_INSIDE_DOWN_LV_NAME.str().c_str());
...
//  const G4double NEW_CENTER = 320.*cm;
  ...
  G4Trd *HB1_FRAME_V_DPA1 = new G4Trd("Helium Bag Frame DPA1",
  				      HB1_FRAME_SHORT_SIDE_X_DPA1/2,
			              ...
			              HB1_FRAME_Z_DPA1/2);
  G4LogicalVolume *HB1_FRAME_LV_DPA1 = new G4LogicalVolume(HB1_FRAME_V_DPA1, HeGas, "HB1_FRAME_LV_DPA1");
  ...
  G4Trd *HB_FRAME_V_DPA2 = new G4Trd("Helium Bag Frame DPA2",
			       ...
			       HB_FRAME_Z_DPA2/2);
  G4LogicalVolume *HB_FRAME_LV_DPA2 = new G4LogicalVolume(HB_FRAME_V_DPA2, HeGas, "HB_FRAME_LV_DPA2");
