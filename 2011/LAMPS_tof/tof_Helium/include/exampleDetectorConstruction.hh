...
//them as 0 in the constructor . Finally , allocate them in function	below .
...
//    G4Element* elHe; //SK
    ...
    G4Material* Air;
    G4Material* Scint;
    G4Material* Water; //SKChanged..
    G4Material* Vacuum;//SKChanged..
    G4Material* dummyMat;//SKChanged..
    G4Material* HeliumGas; //SK

    G4double labX, labY, labZ;
    G4double detX, detY, detZ;
    G4int layerNum; //SKChanged..
};
#endif
