...
G4VPhysicalVolume* exampleDetectorROGeometry::Build()
{
  ...
  //make voxel
  G4Box* RODetXVoxelSolid = new G4Box("RODetXVoxelSolid", detX/numOfXVoxels/2,
							  detY/2,
							  detZ/2);
  ...
  G4Box* RODetYVoxelSolid = new G4Box("RODetYVoxelSolid", detX/numOfXVoxels/2,
							  detY/numOfYVoxels/2,
							  detZ/2);
  ...
  G4Box* RODetZVoxelSolid = new G4Box("RODetZVoxelSolid", detX/numOfXVoxels/2,
							  detY/numOfYVoxels/2,
							  detZ/numOfZVoxels/2);
