...
//	const G4double d_FROM_CENTER_FPD = 5*m; //temp
	...
	const G4double dx_FROM_CENTER_FPD = DP_R_CENT*(1-TMath::Cos(DP_DEFLECTION_ANGLE))+ FPD_d_FROM_DPsurface*(TMath::Sin(DP_DEFLECTION_ANGLE))-8*cm;
//	const G4double dx_FROM_CENTER_FPD = DP_R_CENT*(1-TMath::Cos(DP_DEFLECTION_ANGLE))+ FPD_d_FROM_DPsurface*(TMath::Sin(DP_DEFLECTION_ANGLE)); //05_LAMPS
...
//	FPD_ROTATE -> rotateY(FPD_tilted_ANGLE-FPD_rot_ANGLE);
	FPD_ROTATE -> rotateY(FPD_tilted_ANGLE-FPD_rot_ANGLE+3*deg); //05_LAMPS
