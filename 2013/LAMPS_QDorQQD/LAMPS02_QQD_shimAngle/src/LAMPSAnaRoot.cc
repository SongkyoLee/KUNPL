...
void LAMPSAnaRoot::FillFPD(Int_t r_pNum, Int_t r_parentID, Int_t r_pID, Double_t r_x, Double_t r_y, Double_t r_z, Double_t r_energyDeposit, Double_t r_hitTime)
{
	if (r_energyDeposit == 0) return;
